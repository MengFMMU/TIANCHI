...
tf.app.flags.DEFINE_string('annotation_file', None,
                           """Path to nodule annotation csv file.""")
tf.app.flags.DEFINE_string('prediction_file', None,
                           """Path to prediction csv file.""")
tf.app.flags.DEFINE_integer('batch_size', 256,
                            """Number of images to process in a batch.""")
tf.app.flags.DEFINE_integer('image_size', 48,
...
def inference(images):
    ...
    with tf.variable_scope('conv1') as scope:
        ...
        biases = _variable_on_cpu('biases', [n_f], tf.constant_initializer(0.0))
    ...
    with tf.variable_scope('conv2') as scope:
        ...
        biases = _variable_on_cpu('biases', [n_f], tf.constant_initializer(0.1))
        pre_activation = tf.nn.bias_add(conv, biases)
